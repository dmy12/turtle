...
"""
   ...
   * * * * * * * *
   ...
   - Place the file in the same directory as __main__.py
...
class DemoWindow(object):
    ...
    def __init__(self, filename=None):
        ...
        root.grid_columnconfigure(4, minsize=90, weight=1)
        ...
        self.save_btn = Button(root, text=" SAVE ", font=btnfont,
                                fg="white", disabledforeground="#fed",
                                command = self.saveCanvas)
        ...
        self.save_btn.grid(row=1, column=4, sticky='ew')
        ...
        self.configGUI(DISABLED, DISABLED, DISABLED, DISABLED,
    ...
    def makeGraphFrame(self, root):
        ...
        self.canvwidth = 600#1000
        self.canvheight = 600#800
        turtle._Screen._canvas = self._canvas = canvas = turtle.ScrolledCanvas(
                root, 600, 600, self.canvwidth, self.canvheight)
    ...
    def configGUI(self, start, stop, clear, save, txt="", color="blue"):
        ...
        self.save_btn.config(state=save,
                              bg="#d00" if save == NORMAL else"#fca")
    ...
    def startDemo(self):
        ...
        self.configGUI(DISABLED, NORMAL, DISABLED, NORMAL, 
                       "demo running...", "black")
        self.screen.clear()
        ...
        try:
            ...
            result = "stopped!"
        if self.state == DONE:
            self.configGUI(NORMAL, DISABLED, NORMAL, NORMAL, 
                           result)
    ...
    def stopIt(self):
        if self.exitflag:
            self.clearCanvas()
            self.exitflag = False
            self.configGUI(NORMAL, DISABLED, DISABLED, NORMAL,
                           "STOPPED!", "red")
        turtle.TurtleScreen._RUNNING = False
